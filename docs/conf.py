...
"""
edx-enterprise-subsidy-client documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'edx-enterprise-subsidy-client',  # Repo name
...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/edx-enterprise-subsidy-client",
...
#
# html_title = 'edx-enterprise-subsidy-client v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Client for interacting with the enterprise-subsidy service.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'src', 'edx_enterprise_subsidy_client'),
                os.path.join(root_path, 'src', 'edx_enterprise_subsidy_client', 'migrations')])
