...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_enterprise_subsidy_client'),
                os.path.join(root_path, 'edx_enterprise_subsidy_client/migrations')])
